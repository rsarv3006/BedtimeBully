...
///         }
///     }
public struct ScheduleTemplateRequest: Queryable {
    // MARK: - Queryable Implementation
    public init () {}
    
    public static var defaultValue: [GRDBScheduleTemplate] { [] }
    
    public func publisher(in appDatabase: AppDatabase) -> AnyPublisher<[GRDBScheduleTemplate], Error> {
    ...
    func fetchValue(_ db: Database) throws -> [GRDBScheduleTemplate] {
            return try GRDBScheduleTemplate.all().fetchAll(db)
    }
}
